...
#??? this wil delete all the houses that are being made before it XD
#mc.setBlocks(x-100, y, z-100, x+100, y+150, z+100, bl.AIR)
...
#     # Table
    ...
    mc.setBlocks(h_x1+4, y1, h_z1+(z_len-2)-2, h_x1+4,y1,h_z1+(z_len-2)-2,bl.STAIRS_WOOD.id, 6)
    mc.setBlocks(h_x1+2, y1, h_z1+(z_len-2)-2, h_x1+2,y1,h_z1+(z_len-2)-2,bl.STAIRS_WOOD.id, 6)
    mc.setBlocks(h_x1+3, y1, h_z1+(z_len-2)-3, h_x1+3,y1,h_z1+(z_len-2)-3,bl.STAIRS_WOOD.id, 6)
    mc.setBlocks(h_x1+3, y1, h_z1+(z_len-2)-1, h_x1+3,y1,h_z1+(z_len-2)-1,bl.STAIRS_WOOD.id, 6)

    mc.setBlocks(h_x1 + 3, y1, h_z1+(z_len-2) -2, h_x1 +3,y1,h_z1+(z_len-2)-2,bl.STAINED_GLASS.id, 4)
