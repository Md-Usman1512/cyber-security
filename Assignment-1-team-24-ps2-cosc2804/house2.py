...
def House(x1, y1, z1) -> vec3.Vec3:
    ...
    mc.setBlocks(h_x2 - 1, y1, h_z2 - 1, h_x2 - 1, y1 + 1, h_z2 - 1, bl.COBBLESTONE)
    mc.setBlocks(h_x2 - 1, y1, h_z2 - 2, h_x2 - 1, y1 + 1, h_z2 - 2, bl.COBBLESTONE)
    mc.setBlocks(h_x2 - 1, y1, h_z2 - 3, h_x2 - 1, y1 + 2, h_z2 - 3, bl.COBBLESTONE)
    mc.setBlocks(h_x2 - 1, y1, h_z2 - 4, h_x2 - 1, y1 + 3, h_z2 - 4, bl.COBBLESTONE)
    ...
    if door_side == 1:
        ...
        if window_len != 0:
            ...
            mc.setBlocks(h_x1, y1 + 6, h_z1 + win_start, h_x1,  y1 + 7, h_z1 + window_len, bl.GLASS.id)
